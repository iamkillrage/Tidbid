...
<head>
  ...
  <link rel="stylesheet" href="{{asset('agoraLib/vendor/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{asset('agoraLib/index.css')}}">
</head>
<body>
  ...
  <div id="success-alert" class="alert alert-success alert-dismissible fade show" role="alert">
    <strong>Congratulations!</strong><span> You can invite others join this channel by click </span><a href="" target="_blank" class="getjoinValue">here</a>
    ...
    <form id="join-form">
      <div class="row join-info-group">
          <div class="col-sm">
            ...
            <input id="appid" type="text" placeholder="enter appid" value="3615951fe3a34bf1b3ac0527ed5797a4" required>
          ...
          <div class="col-sm">
            ...
            <input id="channel" type="text" placeholder="enter channel name" value="1-2" required>
  ...
  <script src="{{asset('agoraLib/vendor/jquery-3.4.1.min.js')}}"></script>
  <script src="{{asset('agoraLib/vendor/bootstrap.bundle.min.js')}}"></script>
  <script src="{{asset('agoraLib/AgoraRTC_N-4.20.2.js')}}"></script>
  <script src="{{asset('agoraLib/index.js')}}"></script>
  @php
        $streemId = request('streemId');
  ...
  <script>
    ...
    function get(){
      var getjoinValue = $('.getjoinValue').attr('href');
      var streemId = "{{$streemId}}";
      var userId = "{{$userId}}"
        if(getjoinValue){
            $.ajax({
                 url:"{{('joinUserChanel')}}",
                 data:{getjoinValue:getjoinValue,
                  streemId:streemId,
                  userId:userId
      ...
      //alert(getjoinValue); // To check the value in the console
    }
    setTimeout(function(){
      get()
            }, 3000);
