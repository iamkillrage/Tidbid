   ...
   <div class="icon_box">
      <ul class="comment_box2 pb-0">
         ...
         <li><a href="javascript:void(0)">
               ...
               <i class="fa fa-heart addClass_{{$value->id}}" data-post="<?php print_r($postLike) ?>" onclick="likePost('{{$value->id}}')"></i>
               @else
               <i class="far fa-heart addClass_{{$value->id}}" data-post="<?php print_r($postLike) ?>" onclick="likePost('{{$value->id}}')"></i>
               @endif
            </a>
         </li>
