                    ...
                    <div class="col-lg-12 ">
                        <div class="influ_text about_banner">
                            ...
                            <ul class="banner_list">
                                <li><a href="{{route('Influencer_index')}}">Home</a><i class="far fa-angle-right"></i>
                                </li>
                                <li><a href="{{route('Influencer_About_us')}}" class="active">About us</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner_about">
                            <h6>About Us</h6>
                            <h2>Who We Are</h2>
                            <p class="pt-2 pb-2 text-dark" style="line-height: 24px;"><b>We are growing with a large
