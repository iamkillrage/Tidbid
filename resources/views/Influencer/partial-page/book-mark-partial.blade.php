...
<div class="postright" style=".postright{    margin-bottom: 0;}" id="remove-post_{{$value->id}}">
    <div class="post_profile">
        <div class="postimg">
            ...
            <div class="person_text">
                <h5>{{$value->getInfluencers ? $value->getInfluencers->userName : ''}}</h5>
        ...
        <div class="dropdown dropdown-action">
            <div class="elipse-wrap_{{$value->id}} elipse-wrap">
                ...
                <div class="show-elipse-card_{{$value->id}} boxsize_1 showbutton_{{ $value->id }}" style="display: none;">
                    ...
                    <button class="dropdown-item report-click btn-elipse1 elipse_2 edit-link" data-id="{{$value->id}}" data-bs-toggle="modal" data-bs-target="#exampleModal"><img src="{{asset('Influencer/images/report.svg')}}"> Report</button>
                </div>
            </div>
        </div>
    ...
    <div class="icon_box">
        <ul class="comment_box2 pb-0">
            ...
            <li><a href="javascript:void(0)" onclick="getPostComment('{{$value->id}}')"><i class="far fa-comment"></i></a></li>
    ...
    <div class="desc_box"><img src="{{asset('Influencer/images/login_img.png')}}"><a href="#" class="pinktext" data-bs-toggle="modal" data-bs-target="#like_popup">Liked by</a>
